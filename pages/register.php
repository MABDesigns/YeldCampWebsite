...
<head>
    ...
    <title>Yelp Camp - Register</title>
</head>
<body>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-lg mx-auto loginform">
                ...
                <form>
                    ...
                    <div class="d-grid">
                    <button type="submit" class="btn btn-login">Create an account</button>
                    <div class="text-muted">Already a user? <a href="login.php">Sign in</a></div>
                    </div>
                </form>
        </div>
        <div class="col-lg">
